Example for Configuring Unidirectional CHAP Authentication
==========================================================
...
On the network shown in [Figure 1](#EN-US_TASK_0172364193__fig_dc_vrp_ppp_cfg_002301), DeviceA and DeviceB are connected through LMP interfaces. DeviceA is required to authenticate DeviceB in CHAP mode, and a username needs to be configured for DeviceA.

**Figure 1** Networking diagram for configuring unidirectional CHAP authentication![](../../../../public_sys-resources/note_3.0-en-us.png) 
...
2. Perform configuration on the LMP interface of DeviceA to enable DeviceA to authenticate DeviceB in CHAP mode.
3. Configure a username on the LMP interface of DeviceA.
4. Configure a username and password on the LMP interface of DeviceB.
...
1. Configure DeviceA.
   ...
   # Configure DeviceA to authenticate DeviceB in CHAP mode.
   
   ```
   [*DeviceA-Lmpif0/1/0] ppp authentication-mode chap
   ```
   
   # Configure a username on DeviceA.
