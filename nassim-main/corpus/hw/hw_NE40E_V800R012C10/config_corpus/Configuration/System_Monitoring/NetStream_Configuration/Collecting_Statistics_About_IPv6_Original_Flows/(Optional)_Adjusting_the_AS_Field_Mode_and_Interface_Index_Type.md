...
2. Run [**ipv6 netstream as-mode**](cmdqueryname=ipv6+netstream+as-mode) { **16** | **32** }
...
3. Run [**ipv6 netstream export index-switch**](cmdqueryname=ipv6+netstream+export+index-switch) { **16** | **32** }
   ...
   The length type of the interface index carried in the NetStream packets output by the device is configured.
