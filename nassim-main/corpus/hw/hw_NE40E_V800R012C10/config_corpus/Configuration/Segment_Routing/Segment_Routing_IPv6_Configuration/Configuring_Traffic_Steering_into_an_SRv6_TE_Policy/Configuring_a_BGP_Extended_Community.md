...
1. Configure a route-policy.
   ...
   4. Run [**apply extcommunity**](cmdqueryname=apply+extcommunity) **color** *color*
      ...
      The color value ranges from 0 to 4294967295. Currently, it can only be set to 0.
...
2. Apply the route-policy.
   * Apply the route-policy to a BGP IPv4 unicast peer.
     ...
     3. Run [**peer**](cmdqueryname=peer) { *ipv6-address* | *group-name* } **as-number** *as-number*
        
        A BGP peer is specified.
     4. Run [**ipv4-family**](cmdqueryname=ipv4-family) **unicast**
        
        The IPv4 unicast address family view is displayed.
     5. Run [**peer**](cmdqueryname=peer) { *ipv6-address* | *group-name* } [**route-policy**](cmdqueryname=route-policy) *route-policy-name* { **import** | **export** }
   ...
   * Apply the route-policy to a BGP VPNv4 peer.
     ...
     5. Run [**peer**](cmdqueryname=peer) { *ipv6-address* | *group-name* } **enable**
        
        The BGP VPNv4 peer relationship is enabled.
     6. Run [**peer**](cmdqueryname=peer) { *ipv6-address* | *group-name* } [**route-policy**](cmdqueryname=route-policy) *route-policy-name* { **import** | **export** }
