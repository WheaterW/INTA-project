...
On the network shown in [Figure 1](#EN-US_TASK_0184674100__fig184238288365):
...
![](figure/en-us_image_0184683789.png)
...
1. Enable IPv6 forwarding and configure IPv6 addresses for interfaces on PE1, the P, and PE2. In addition, configure IPv4 addresses for interfaces on CE1 and CE2.
...
1. Enable IPv6 forwarding and configure IP addresses for interfaces.
   
   
   
   # Configure PE1. The configurations of PE2 and the P are similar to the configuration of PE1. For detailed configurations, see Configuration Files.
...
3. Configure a VPN instance on each PE, enable the IPv4 address family for the instance, and bind the interface that connects each PE to a CE to the VPN instance on that PE.
   ...
   # Configure an IP address for each interface on the CEs, as shown in [Figure 1](#EN-US_TASK_0184674100__fig184238288365). For configuration details, see [Configuration Files](#EN-US_TASK_0184674100__example121226172748) in this section.
