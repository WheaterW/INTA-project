Example for Configuring EVPN VPLS over IS-IS SRv6 BE (CE Dual-Homing)
=====================================================================

This section provides an example for configuring SRv6 BE to carry EVPN VPLS services. In the example, a redundancy mode needs to be configured on a per Ethernet segment identifier (ESI) basis.

#### Networking Requirements

On the network shown in [Figure 1](#EN-US_TASK_0227408534__fig_dc_vrp_srv6_cfg_all_002201), CE2 and CE3 are both dual-homed to PE2 and PE3. It is required that CE1-to-CE2 traffic be transmitted in load-balancing mode, whereas CE1-to-CE3 traffic be transmitted in non-load-balancing mode.
...
![](figure/en-us_image_0227408781.png)
...
* BD IDs
* Locator names for PE1: PE1\_BUM and PE1\_UNICAST; locator names for PE2: PE2\_BUM and PE2\_UNICAST; locator names for PE3: PE3\_BUM and PE3\_UNICAST; dynamically generated operation code (opcode)
...
3. Configure a BD EVPN instance on each PE.
   ...
   The preceding example uses the configuration of PE1. The configurations of other devices are similar to the configuration of PE1. For configuration details, see [Configuration Files](#EN-US_TASK_0227408534__section_dc_vrp_srv6_cfg_all_002205) in this section.
4. Establish BGP EVPN peer relationships among the PEs.
