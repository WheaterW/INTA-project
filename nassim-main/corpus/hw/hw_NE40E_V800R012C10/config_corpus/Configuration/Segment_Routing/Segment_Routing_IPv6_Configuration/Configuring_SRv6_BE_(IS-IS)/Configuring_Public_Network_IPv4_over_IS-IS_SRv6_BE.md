Configuring Public Network IPv4 over IS-IS SRv6 BE
==================================================

This section describes how to configure public network IPv4 over SRv6 BE.

#### Usage Scenario

Public network IPv4 over SRv6 BE allows SRv6 BE paths on a public network to carry public network IPv4 services. The key implementation of public network IPv4 over SRv6 BE involves establishing SRv6 BE paths, advertising BGP routes, and forwarding data. [Figure 1](#EN-US_TASK_0227330332__fig_dc_vrp_srv6_cfg_all_001201) shows an example where an IPv6 public network is established between PE1 and PE2. An SRv6 BE path can be deployed on the IPv6 public network to carry public network IPv4 services.

**Figure 1** Public network IPv4 over SRv6 BE networking  
![](figure/en-us_image_0227330336.png)

#### Pre-configuration Tasks

Before configuring public network IPv4 over SRv6 BE, complete the following tasks:
...
5. Enable IS-IS SRv6.
   ...
   3. Run [**segment-routing ipv6 locator**](cmdqueryname=segment-routing+ipv6+locator) *locator-name* [ **auto-sid-disable** ]
...
After configuring public network IPv4 over SRv6 BE, verify the configuration.
