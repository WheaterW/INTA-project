...
4. (Optional) Run [**target-board**](cmdqueryname=target-board) *slot-number* [ **backup** *slave-slot-number* ]
...
5. Run [**binding tunnel gre**](cmdqueryname=binding+tunnel+gre)
