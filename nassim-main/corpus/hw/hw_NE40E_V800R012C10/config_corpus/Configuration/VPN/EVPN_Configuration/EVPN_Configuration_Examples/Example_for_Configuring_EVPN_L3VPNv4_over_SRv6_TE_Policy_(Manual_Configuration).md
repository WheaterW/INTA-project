...
On the network shown in [Figure 1](#EN-US_TASK_0000001155039296__en-us_task_0216268908_fig3691666259), PE1, the P, and PE2 are in the same AS and run IS-IS to implement IPv6 network connectivity. It is required that a bidirectional SRv6 TE Policy be deployed between PE1 and PE2 to carry EVPN L3VPNv4 services.
...
![](figure/en-us_image_0216271268.png)
...
1. Enable IPv6 forwarding and configure an IPv6 address for each interface.
   ...
   # Configure PE1. The configurations of the P and PE2 are similar to the configuration of PE1. For configuration details, see [Configuration Files](#EN-US_TASK_0000001155039296__en-us_task_0216268908_example121226172748) in this section.
