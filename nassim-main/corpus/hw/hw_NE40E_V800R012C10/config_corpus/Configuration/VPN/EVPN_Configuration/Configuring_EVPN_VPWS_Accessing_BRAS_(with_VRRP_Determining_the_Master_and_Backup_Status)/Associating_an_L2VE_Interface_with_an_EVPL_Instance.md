...
2. Run [**interface virtual-ethernet**](cmdqueryname=interface+virtual-ethernet) *interface-number*.*subinterface-number* **mode l2**
   
   
   
   The VE Layer 2 sub-interface view is displayed.
