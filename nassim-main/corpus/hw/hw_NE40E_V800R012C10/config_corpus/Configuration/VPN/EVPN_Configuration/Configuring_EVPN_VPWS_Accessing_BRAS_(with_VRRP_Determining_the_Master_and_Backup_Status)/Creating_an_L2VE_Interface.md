...
4. Run [**esi**](cmdqueryname=esi) *esi*
   ...
   After an ESI is configured for BNGs' L2VE interfaces connected to M-AGGs, BNG1 and BNG2 can obtain each other's ESI through route advertisement and detect that M-AGGs are dual-homed to them.
