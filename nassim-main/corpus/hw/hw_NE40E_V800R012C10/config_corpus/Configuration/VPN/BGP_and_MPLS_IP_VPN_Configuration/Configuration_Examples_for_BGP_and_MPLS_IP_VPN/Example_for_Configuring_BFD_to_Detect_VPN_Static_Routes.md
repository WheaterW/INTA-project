Example for Configuring BFD to Detect VPN Static Routes
=======================================================
...
On the network shown in [Figure 1](#EN-US_TASK_0172369567__fig_dc_vrp_mpls-l3vpn-v4_cfg_012801), CE1 and CE2 belong to VPNA. Two default routes with the next hops as PE1 and PE2 respectively are configured on CE1. The two routes work in load-balancing mode. The static routes bound to VPNA are configured on PE1 and PE2 separately and are imported into BGP.
