...
4. Configure rapid service link switching.
   ...
   3. Run [**binding interface**](cmdqueryname=binding+interface) { *interface-type**interface-number* | *interface-name* } [ **down-weight***down-weight-value* ]
   ...
   11. (On the interface that connects to a downstream device) Run [**multicast track vrrp**](cmdqueryname=multicast+track+vrrp) **vrid** *vrid-value*
