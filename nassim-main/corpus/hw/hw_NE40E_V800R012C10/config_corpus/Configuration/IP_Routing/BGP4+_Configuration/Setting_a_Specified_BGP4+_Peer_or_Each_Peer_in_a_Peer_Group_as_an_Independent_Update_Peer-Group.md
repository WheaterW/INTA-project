...
Before setting a specified peer or each peer in a peer group as an independent update peer-group, [configure basic BGP4+ functions](dc_vrp_bgp6_cfg_0003.html).
...
4. Set a specified peer or each peer in a peer group as an independent update peer-group.
   ...
   * To set a specified peer as an independent update peer-group, run the [**peer**](cmdqueryname=peer+update-group-independent+enable) { *ipv4-address* | *ipv6-address* } **update-group-independent** **enable** command.
