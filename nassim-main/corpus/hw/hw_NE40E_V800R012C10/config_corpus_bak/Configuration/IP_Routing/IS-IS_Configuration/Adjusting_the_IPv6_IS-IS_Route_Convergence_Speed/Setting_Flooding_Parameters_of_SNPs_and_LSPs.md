...
* [Set an interval at which CSNPs are sent.](#EN-US_TASK_0172366039__step_dc_vrp_isis_cfg_001701)
* [Configure the intelligent timer to control LSP generation.](#EN-US_TASK_0172366039__step_dc_vrp_isis_cfg_001702)
* [Set the size of an LSP.](#EN-US_TASK_0172366039__step_dc_vrp_isis_cfg_001703)
* [Set the LSP update interval.](#EN-US_TASK_0172366039__step_dc_vrp_isis_cfg_001704)
* [Set the maximum lifetime for LSPs.](#EN-US_TASK_0172366039__step_dc_vrp_isis_cfg_001705)
* [Set the maximum holdtime for the largest IS-IS route cost in local LSPs.](#EN-US_TASK_0172366039__step_dc_vrp_isis_cfg_104210)
* [Enable LSP fast flooding](#EN-US_TASK_0172366039__step_dc_vrp_isis_cfg_001706).
* [Set an interval at which LSPs are retransmitted over a P2P link.](#EN-US_TASK_0172366039__step_dc_vrp_isis_cfg_001708)
* [Configure automatic IS-IS LSP Remaining Lifetime adjustment](#EN-US_TASK_0172366039__step_dc_vrp_isis_cfg_001709).
...
* Set the size of an LSP.
  ...
  4. Run [**lsp-length**](cmdqueryname=lsp-length) **receive** *max-size*
     ...
     *max-size* of an LSP to be generated must be less than or equal to *max-size* of an LSP to be received.
     ...
     The value of *max-size* in the [**lsp-length**](cmdqueryname=lsp-length) command must meet the following conditions.
...
* Set the maximum holdtime for the largest IS-IS route cost in local LSPs.
  ...
  2. Run [**interface**](cmdqueryname=interface) *interface-type* *interface-number*
     ...
     The interface view is displayed.
  3. Run [**isis**](cmdqueryname=isis) [ **process-id** *process-id* ] **peer hold-max-cost** **timer** *timer-val*
...
* Set an interval at which LSPs are retransmitted over a P2P link.
  ...
  2. Run [**interface**](cmdqueryname=interface) *interface-type* *interface-number*
     ...
     The interface view is displayed.
  3. (Optional) Run [**isis circuit-type**](cmdqueryname=isis+circuit-type) **p2p**
