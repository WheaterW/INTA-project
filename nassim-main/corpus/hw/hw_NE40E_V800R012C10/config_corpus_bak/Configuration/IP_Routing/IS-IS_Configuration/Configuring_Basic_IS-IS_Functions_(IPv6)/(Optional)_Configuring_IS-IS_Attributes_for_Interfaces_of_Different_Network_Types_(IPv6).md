(Optional) Configuring IS-IS Attributes for Interfaces of Different Network Types (IPv6)
========================================================================================
...
* Set the negotiation mode for the establishment of neighbor relationships over P2P links.
  ...
  3. Run [**isis ppp-negotiation**](cmdqueryname=isis+ppp-negotiation) { **2-way** | **3-way** [ **only** ] }
     ...
     This command applies only to neighbor relationship establishment over P2P links. In the case of a broadcast link, you can run the [**isis circuit-type**](cmdqueryname=isis+circuit-type) **p2p** command to set the link type to P2P, and then run the [**isis ppp-negotiation**](cmdqueryname=isis+ppp-negotiation) command to set the negotiation mode for the establishment of the neighbor relationship.
  4. Run [**commit**](cmdqueryname=commit)
