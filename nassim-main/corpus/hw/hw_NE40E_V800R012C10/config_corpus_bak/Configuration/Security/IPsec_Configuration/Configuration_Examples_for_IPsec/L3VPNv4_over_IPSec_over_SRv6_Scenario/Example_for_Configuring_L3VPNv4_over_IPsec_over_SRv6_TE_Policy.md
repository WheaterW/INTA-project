...
* IPsec policy name on PE1 and PE2
...
* Configure PE1 and PE2.
  ...
  | Configure an SRv6 SID and IS-IS SRv6, and enable VPN routes to carry the SID attribute. | ``` segment-routing ipv6  encapsulation source-address 2001:DB8:1::1  locator as1 ipv6-prefix 2001:DB8:100:: 64 static 32   opcode ::111 end no-flavor # bgp 100  ipv4-family vpnv4   peer 2001:DB8:3::3 prefix-sid  ipv4-family vpn-instance vpna   segment-routing ipv6 traffic-engineer best-effort   segment-routing ipv6 locator as1 # isis 1  segment-routing ipv6 locator as1 auto-sid-disable ``` | ``` segment-routing ipv6  encapsulation source-address 2001:DB8:3::3  locator as1 ipv6-prefix 2001:DB8:300:: 64 static 32   opcode ::333 end no-flavor # bgp 100  ipv4-family vpnv4   peer 2001:DB8:1::1 prefix-sid  ipv4-family vpn-instance vpna   segment-routing ipv6 traffic-engineer best-effort   segment-routing ipv6 locator as1 # isis 1  segment-routing ipv6 locator as1 auto-sid-disable ``` |
  | Configure an SRv6 TE Policy. | ``` segment-routing ipv6  segment-list list1   index 5 sid ipv6 2001:DB8:200::222   index 10 sid ipv6 2001:DB8:300::333  srv6-te-policy locator as1  srv6-te policy policy1 endpoint 2001:DB8:3::3 color 101   binding-sid 2001:DB8:100::100   candidate-path preference 100    segment-list list1 ``` | ``` segment-routing ipv6  segment-list list1   index 5 sid ipv6 2001:DB8:200::222   index 10 sid ipv6 2001:DB8:100::111  srv6-te-policy locator as1  srv6-te policy policy1 endpoint 2001:DB8:1::1 color 101   binding-sid 2001:DB8:300::300   candidate-path preference 100    segment-list list1 ``` |
  | Then, configure a tunnel policy to import VPN traffic. | ``` route-policy p1 permit node 10  apply extcommunity color 0:101 # bgp 100  ipv4-family vpnv4   peer 2001:DB8:3::3 route-policy p1 import # tunnel-policy p1  tunnel select-seq ipv6 srv6-te-policy load-balance-number 1 # ip vpn-instance vpna  ipv4-family   tnl-policy p1 ``` | ``` route-policy p1 permit node 10  apply extcommunity color 0:101 # bgp 100  ipv4-family vpnv4   peer 2001:DB8:1::1 route-policy p1 import # tunnel-policy p1  tunnel select-seq ipv6 srv6-te-policy load-balance-number 1 # ip vpn-instance vpna  ipv4-family   tnl-policy p1 ``` |
