...
As shown in [Figure 1](#EN-US_TASK_0172372384__fig_dc_vrp_flowspec_cfg_002001), in the VPN, CE1 belongs to AS 100; PE1 and PE2 belong to AS 200, all devices are in the same VPN domain. PE1 is the ingress of the VPN domain in AS 200. AS 200 can communicate with AS 100 through PE1.
...
**Figure 1** Configuring static BGP VPNv6 Flow Specification![](../../../../public_sys-resources/note_3.0-en-us.png) 
...
5. Verify the configuration.
   ...
   # Check the status of the BGP VPNv6 Flow Specification peer relationship on PE2. The command output shows that the BGP VPNv6 Flow Specification peer relationship has been successfully established.
