...
On an inter-AS seamless MPLS+HVPN network that has protection switching enabled, if a link or node fails, traffic switches to a backup path, which implements uninterrupted traffic transmission.

| Tunnel Type | Protected Object | Nodes to Be Configured | Detection Method | Protection Function |
| --- | --- | --- | --- | --- |
| MPLS TE tunnel (without Ps on links at the network layer) | Protects access rings, aggregation rings, and links at the core layer. | All nodes | [Configure BFD for interface.](#EN-US_TASK_0172368668__BFD_interface) | Configure either of the following TE FRR functions:   * [Configure TE manual FRR.](#EN-US_TASK_0172368668__TE_FRR1) * [Configure MPLS TE Auto FRR.](#EN-US_TASK_0172368668__TE_FRR2) |
| MPLS TE tunnel (with Ps on links at the network layer) | Protects access rings, aggregation rings, and links at the core layer. | All nodes | [Configure static BFD for CR-LSP](#EN-US_TASK_0172368668__BFD_CR-LSP1) or [dynamic BFD for CR-LSP.](#EN-US_TASK_0172368668__BFD_CR-LSP2) | [Configure CR-LSP hot standby.](#EN-US_TASK_0172368668__Hotstandby2) |
| MPLS TE tunnel | Protects AGG ASBRs and core ASBRs. | AGGs and MASGs | [Configure BFD for TE.](#EN-US_TASK_0172368668__BFD_TE) | Configure BGP LSP FRR. |
| MPLS TE tunnel | Protects CSGs and AGGs. | CSGs and AGGs | [Configure BFD for TE.](#EN-US_TASK_0172368668__BFD_TE) | Configure either of the following VPN FRR functions:   * [Enable VPN FRR in the VPN instance IPv4 address family view.](#EN-US_TASK_0172368668__VPN1)  [Enable VPN FRR in the BGP-VPN instance IPv4 address family view.](#EN-US_TASK_0172368668__VPN2) |
| MPLS LDP LSP | Protects links on access rings. | CSGs and AGGs | [Configure BFD for interface.](#EN-US_TASK_0172368668__BFD_interface) | [Configure LDP Auto FRR.](#EN-US_TASK_0172368668__LDP2) |
| MPLS LDP LSP | Protects aggregation rings and links, AGG ASBRs, and core ASBRs at the core layer. | AGGs, AGG ASBRs, core ASBRs, and MASGs | [Configure static BFD to monitor an LDP LSP](#EN-US_TASK_0172368668__BFD_LDP1) or [dynamic BFD for LDP LSPs.](#EN-US_TASK_0172368668__BFD_LDP2) | Configure BGP LSP FRR. |
| MPLS LDP LSP | Protects CSGs and AGGs. | CSGs and AGGs | [Configure static BFD to monitor an LDP LSP](#EN-US_TASK_0172368668__BFD_LDP1) or [dynamic BFD for LDP LSPs.](#EN-US_TASK_0172368668__BFD_LDP2) | Configure either of the following VPN FRR functions:   * [Enable VPN FRR in the VPN instance IPv4 address family view.](#EN-US_TASK_0172368668__VPN1)  [Enable VPN FRR in the BGP-VPN instance IPv4 address family view.](#EN-US_TASK_0172368668__VPN2) |
| MPLS TE tunnel or MPLS LDP LSP | Protect links between each pair of an AGG ASBR and a core ASBR. | AGG ASBRs and core ASBRs | [Configure BFD for interface.](#EN-US_TASK_0172368668__BFD_interface) | Configure BGP LSP FRR. |
| MPLS TE tunnel or MPLS LDP LSP | Protects a whole BGP LSP and MP-BGP peers on an L3VPN. | AGGs and MASGs | [Configure BFD for BGP tunnel.](#EN-US_TASK_0172368668__BFD_BGPLSP) | Configure either of the following VPN FRR functions:   * [Enable VPN FRR in the VPN instance IPv4 address family view.](#EN-US_TASK_0172368668__VPN1)  [Enable VPN FRR in the BGP-VPN instance IPv4 address family view.](#EN-US_TASK_0172368668__VPN2) |
...
* Configure LDP Auto FRR.
  ...
  4. Run [**auto-frr lsp-trigger**](cmdqueryname=auto-frr+lsp-trigger+all+host+ip-prefix+none) { **all** | **host** | **ip-prefix** *ip-prefix-name* | **none** }
     ...
     The [**auto-frr lsp-trigger**](cmdqueryname=auto-frr+lsp-trigger) command is affected by the [**lsp-trigger**](cmdqueryname=lsp-trigger) command. If both the [**auto-frr lsp-trigger**](cmdqueryname=auto-frr+lsp-trigger) command and the [**lsp-trigger**](cmdqueryname=lsp-trigger) command are run, the established backup LSPs satisfy both the policy for triggering LDP LSP establishment and the policy for triggering backup LDP LSP establishment.
  5. Run [**commit**](cmdqueryname=commit)
...
* Configure BFD for BGP tunnel.
  ...
  5. Run [**mpls bgp bfd enable**](cmdqueryname=mpls+bgp+bfd+enable)
     ...
     The capability of dynamically establishing BGP BFD sessions is enabled.
...
* Enable VPN FRR in the VPN instance IPv4 address family view.
  ...
  8. (Optional) Run [**peer**](cmdqueryname=peer+mpls-local-ifnet+disable) { *group-name* | *ipv4-address* } **mpls-local-ifnet** **disable**
     ...
     The capability of establishing an MPLS local IFNET tunnel between an AGG and MASG is disabled.
     
     In the inter-AS seamless MPLS+HVPN network transmitting L3VPN services, an AGG and MASG establish an MP-EBGP peer relationship. Therefore, an MPLS local IFNET tunnel between the AGG and MASG is automatically established over the MP-EBGP peer relationship. The MPLS local IFNET tunnel fails to transmit traffic because the AGG and MASG are indirectly connected.
     
     If a fault occurs on the tunnel between the AGG and MASG, traffic recurses to the MPLS local IFNET tunnel, not a backup tunnel or an FRR bypass tunnel. As the MPLS local IFNET tunnel cannot forward traffic, traffic is interrupted. To prevent the traffic interruption, run the [**peer mpls-local-ifnet disable**](cmdqueryname=peer+mpls-local-ifnet+disable) command to disable the establishment of an MPLS local IFNET tunnel between the AGG and MASG.
