Example for Configuring Single-ended Packet Loss Measurement in EVPN Networking
===============================================================================

This section provides an example for configuring single-ended packet loss measurement in EVPN networking.
...
On the network shown in [Figure 1](#EN-US_TASK_0214947558__fig_dc_vrp_cfg_01153201), CFM is configured between each PE and its attached CE. CCMs are not used to monitor link connectivity, preventing them from consuming a lot of bandwidth resources. To provide higher-quality voice services, a carrier expects to monitor packet loss performance on mobile transport links in real time so that they can promptly respond to calling service quality deterioration.

**Figure 1** Configuring Y.1731 functions in VLAN networking![](../../../../public_sys-resources/note_3.0-en-us.png) 

In this example, interface1 and interface2 represent GE 0/1/1 and GE 0/1/2, respectively.


  
![](figure/en-us_image_0215261397.png)

#### Configuration Roadmap

The configuration roadmap is as follows:

1. Configure on-demand single-ended packet loss measurement for the AC between PE1 and its attached CE to collect packet loss statistics.
2. Configure proactive single-ended packet loss measurement for the AC between PE2 and its attached CE to collect packet loss statistics.
...
1. Configure on-demand single-ended packet loss measurement for the AC between PE1 and its attached CE.
   
   
   1. Configure EVPN functions.
      
      Configure an EVPN connection between PE1 and PE2. For details, see the [EVPN Configuration](dc_vrp_evpn_cfg_0000.html) or [Configuration Files](#EN-US_TASK_0214947558__example1654568432214024) in this configuration example.
   ...
   3. Enable CE1 to receive LMMs.
      ...
      ```
      [~CE1-md-md1-ma-ma2] loss-measure single-ended receive test-id 1
      ```
      ```
      ...
      [*CE1] commit
      ```
   4. Enable on-demand single-ended packet loss measurement in EVPN networking.
   ...
   5. Verify the configuration.
      ...
      After the configuration is complete, run the [**display y1731 statistic-type**](cmdqueryname=display+y1731+statistic-type) command on PE1 to view statistics about single-ended packet loss.
      ...
      ```
2. Configure proactive single-ended packet loss measurement for the AC between PE2 and its attached CE.
   
   ![](../../../../public_sys-resources/note_3.0-en-us.png) 
   
   To continuously collect statistics about packet loss on an AC between a CE and PE, configure proactive single-ended packet loss measurement.
   ...
   2. Enable CE2 to receive LMMs.
      ...
      [*CE2] commit
      ```
   3. Enable proactive single-ended packet loss measurement in EVPN networking.
   ...
   4. Verify the configuration.
      ...
      After the configuration is complete, run the [**display y1731 statistic-type**](cmdqueryname=display+y1731+statistic-type) command on PE2 to view statistics about single-ended packet loss.
