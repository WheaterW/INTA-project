...
A U-BFD Echo session has been configured.
...
* Run the [**display bfd interface**](cmdqueryname=display+bfd+interface) command to check information about BFD interfaces.