...
On the network shown in [Figure 1](#EN-US_TASK_0319173982__fig_dc_vrp_vpws_cfg_301501), PE1, the P, and PE2 belong to the same AS and run IS-IS for IPv6 network connectivity. It is required that a bidirectional SRv6 TE Policy be deployed between PE1 and PE2 to carry VPWS services.
