...
1. Configure interface IP addresses.
   ...
   Assign an IP address to each interface of Spoke 1 and Spoke 2 according to [Figure 1](#EN-US_TASK_0172369161__fig_dc_cfg_dsvpn_001602). The configurations of the spokes are similar to the configuration of the hub.
...
5. Configure tunnel interfaces.
   ...
   Set the OSPF network type to P2MP on Hub and spokes. Enable the NHRP redirection function on the hub. Configure NHRP mapping entries related to Hub and enable the NHRP shortcut function on Spoke 1 and Spoke 2.
   ...
   # Configure a tunnel interface, OSPF route attributes, and Hub's static NHRP peer entry, and enable the NHRP shortcut function on Spoke 1.
   ```
   ...
   [*Spoke1-Tunnel0] quit
   [*Spoke1-Tunnel0] commit
   ```
   
   # Configure a tunnel interface, OSPF route attributes, and the Hub's static NHRP peer entry, and enable the NHRP shortcut function on Spoke 2.
   ```
