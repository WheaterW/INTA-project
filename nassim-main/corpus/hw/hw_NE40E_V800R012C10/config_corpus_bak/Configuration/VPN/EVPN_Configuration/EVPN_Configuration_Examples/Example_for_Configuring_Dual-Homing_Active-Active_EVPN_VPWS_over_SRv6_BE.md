Example for Configuring Dual-Homing Active-Active EVPN VPWS over SRv6 BE
========================================================================
...
On the network shown in [Figure 1](#EN-US_TASK_0000001200768177__en-us_task_0227770256_fig_dc_vrp_srv6_cfg_all_002201), CE2 is dual-homed to PE2 and PE3. It is required that CE1-to-CE2 traffic be transmitted in load-balancing mode.
...
9. Configure CE access to the PEs.
   ...
   According to the status of Eth-Trunk 10 shown in the preceding command output, PE2 and PE3 are both active.
