Configuring the SyncE Function on the Device Where the Atom GPS Module Resides
==============================================================================
...
Perform the following steps on the device equipped with the Atom GPS 1.0 module (AE 905S module):
...
4. Run the [**clock priority**](cmdqueryname=clock+priority) *priority-value* command to configure a priority for the clock reference source of the interface.
