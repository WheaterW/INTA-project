Verifying the Configuration for a Device to Communicate with an NMS Through SNMPv1
==================================================================================
...
* Run the [**display current-configuration**](cmdqueryname=display+current-configuration) **configuration** **snmp** command to view the current configuration of SNMP.
