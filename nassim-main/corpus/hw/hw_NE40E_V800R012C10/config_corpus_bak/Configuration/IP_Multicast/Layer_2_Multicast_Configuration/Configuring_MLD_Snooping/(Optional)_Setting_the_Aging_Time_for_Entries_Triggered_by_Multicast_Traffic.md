...
Before setting the aging time for entries triggered by multicast traffic, enable MLD snooping both globally and in a specified VLAN or VSI.
...
3. Run [**l2-multicast ipv6 source-lifetime**](cmdqueryname=l2-multicast+ipv6+source-lifetime) *lifetime*
   
   
   
   The aging time is set for entries triggered by multicast traffic in the VLAN or VSI.
