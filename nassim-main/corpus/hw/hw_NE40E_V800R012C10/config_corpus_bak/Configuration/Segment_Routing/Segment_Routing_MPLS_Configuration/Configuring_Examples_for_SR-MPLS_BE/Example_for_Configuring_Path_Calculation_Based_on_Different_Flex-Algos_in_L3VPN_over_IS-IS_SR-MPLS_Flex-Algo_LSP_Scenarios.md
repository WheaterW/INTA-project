...
On the network shown in [Figure 1](#EN-US_TASK_0279236427__fig_dc_vrp_sr-be_cfg_000501):
...
**Figure 1** Networking for path calculation based on different Flex-Algos in L3VPN over IS-IS SR-MPLS Flex-Algo LSP scenarios![](../../../../public_sys-resources/note_3.0-en-us.png) 

Interfaces 1 through 3 in this example stand for GE 0/1/0, GE 0/2/0, and GE 0/3/0, respectively.


  
![](figure/en-us_image_0279236554.png)
...
8. Configure a VPN instance on each PE, enable the IPv4 address family for the instance, and bind the interface that connects each PE to a CE to the VPN instance on that PE.
   ...
   # Assign an IP address to each interface on the CEs, as shown in [Figure 1](#EN-US_TASK_0279236427__fig_dc_vrp_sr-be_cfg_000501). For detailed configurations, see Configuration Files.
