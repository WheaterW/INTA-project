Example for Configuring L3VPN over Dynamic SR-MPLS TE Policy (Color-Based)
==========================================================================

Configure L3VPN to ensure secure communication between users in the same VPN instance.

#### Networking Requirements

On the network shown in [Figure 1](#EN-US_TASK_0172368903__fig_dc_vrp_sr_all_cfg_008301):

* CE1 and CE2 belong to a VPN instance named **vpna**.
* The VPN target used by **vpna** is 111:1.

Configure L3VPN over SR-MPLS TE Policy to ensure secure communication between users in the same VPN instance. Because multiple links exist between PEs on the public network, other links must be able to provide protection for the primary link.
...
**Figure 1** L3VPN route recursion to dynamically delivered SR-MPLS TE Policies![](../../../../public_sys-resources/note_3.0-en-us.png) 

Interfaces 1 through 4 in this example represent GE 0/1/1, GE 0/1/2, GE 0/1/3, and GE 0/1/4, respectively.


  
![](images/fig_dc_vrp_sr_all_cfg_008301.png)
...
1. Configure interface IP addresses for each device on the backbone network.
   ...
   ```
   ```
   [*PE1-GigabitEthernet0/1/1] ip address 10.13.1.1 24
   ```
   ```
   ...
   ```
   ```
   [*PE1-GigabitEthernet0/1/3] ip address 10.11.1.1 24
   ```
   ```
   ...
   ```
   ```
   [*PE1-GigabitEthernet0/1/4] ip address 10.3.1.1 24
   ```
   ```
   ...
   ```
   ```
   [*P1-GigabitEthernet0/1/1] ip address 10.11.1.2 24
   ```
   ```
   ...
   ```
   ```
   [*P1-GigabitEthernet0/1/2] ip address 10.12.1.1 24
   ```
   ```
   ...
   ```
   ```
   [*PE2-GigabitEthernet0/1/1] ip address 10.14.1.2 24
   ```
   ```
   ...
   ```
   ```
   [*PE2-GigabitEthernet0/1/3] ip address 10.12.1.2 24
   ```
   ```
   ...
   ```
   ```
   [*PE2-GigabitEthernet0/1/4] ip address 10.4.1.1 24
   ```
   ```
   ...
   ```
   ```
   [*P2-GigabitEthernet0/1/1] ip address 10.13.1.2 24
   ```
   ```
   ...
   ```
   ```
   [*P2-GigabitEthernet0/1/2] ip address 10.14.1.1 24
   ```
   ```
   ...
   ```
   ```
   [~Controller] interface gigabitethernet0/1/1
   ```
   ```
   [~Controller-GigabitEthernet0/1/1] ip address 10.3.1.2 24
   ```
   ```
   [*Controller-GigabitEthernet0/1/1] quit
   ```
   ```
   [*Controller] interface gigabitethernet0/1/2
   ```
   ```
   [*Controller-GigabitEthernet0/1/2] ip address 10.4.1.2 24
   ```
   ```
   [*Controller-GigabitEthernet0/1/2] quit
   ```
   ```
   [*Controller] commit
   ```
2. Configure an IGP for each device on the backbone network to implement interworking between PEs and Ps. IS-IS is used as an example.
   ...
   ```
   ```
   [*PE1-GigabitEthernet0/1/3] isis enable 1
   ```
   ```
   [*PE1-GigabitEthernet0/1/3] quit
   ```
   ...
   ```
   ```
   [*P1-GigabitEthernet0/1/1] isis enable 1
   ```
   ```
   [*P1-GigabitEthernet0/1/1] quit
   ```
   ...
   ```
   ```
   [*P1-GigabitEthernet0/1/2] isis enable 1
   ```
   ```
   [*P1-GigabitEthernet0/1/2] quit
   ```
   ...
   ```
   ```
   [*PE2-GigabitEthernet0/1/3] isis enable 1
   ```
   ```
   [*PE2-GigabitEthernet0/1/3] quit
   ```
   ...
   ```
   ```
   [*P2-GigabitEthernet0/1/1] isis enable 1
   ```
   ```
   [*P2-GigabitEthernet0/1/1] quit
   ```
   ...
   ```
   ```
   [*P2-GigabitEthernet0/1/2] isis enable 1
   ```
   ```
   [*P2-GigabitEthernet0/1/2] quit
   ```
...
5. Configure BGP-LS and BGP IPv4 SR-Policy address family peer relationships.
   ...
   After the configuration is complete, the PEs can receive the SR-MPLS TE Policy routes delivered by the controller and then generate SR-MPLS TE Policies. You can run the [**display sr-te policy**](cmdqueryname=display+sr-te+policy) command to check SR-MPLS TE Policy information. The following example uses the command output on PE1.
...
9. Create a VPN instance and enable the IPv4 address family on each PE. Then, bind each PE's interface connecting the PE to a CE to the corresponding VPN instance.
   ...
   ```
   ```
   [*PE1-GigabitEthernet0/1/2] ip binding vpn-instance vpna
   ```
   ```
   [*PE1-GigabitEthernet0/1/2] ip address 10.1.1.2 24
   ```
   ```
   ...
   ```
   ```
   [*PE2-GigabitEthernet0/1/2] ip address 10.2.1.2 24
   ```
   ```
