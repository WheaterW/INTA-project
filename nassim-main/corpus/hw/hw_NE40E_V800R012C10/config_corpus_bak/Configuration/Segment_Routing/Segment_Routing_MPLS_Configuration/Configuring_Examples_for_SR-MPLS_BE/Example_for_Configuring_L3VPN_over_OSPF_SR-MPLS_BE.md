...
In [Figure 1](#EN-US_TASK_0172368863__fig_dc_vrp_sr-be_cfg_000501):
...
**Figure 1** L3VPN recursive to an OSPF SR-MPLS BE tunnel![](../../../../public_sys-resources/note_3.0-en-us.png) 
...
6. Configure VPN instances in the IPv4 address family on each PE and connect each PE to a CE.
   ...
   # Assign an IP address to each interface on CEs as shown in [Figure 1](#EN-US_TASK_0172368863__fig_dc_vrp_sr-be_cfg_000501). The detailed configuration procedure is not provided here. For details, see "Configuration Files".
