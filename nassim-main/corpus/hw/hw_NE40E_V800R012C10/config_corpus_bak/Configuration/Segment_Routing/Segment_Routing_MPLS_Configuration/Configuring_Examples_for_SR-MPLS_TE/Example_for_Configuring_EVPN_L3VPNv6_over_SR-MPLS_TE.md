...
On the network shown in [Figure 1](#EN-US_TASK_0172368880__en-us_task_0172370681_fig16348123515020), EVPN L3VPNv6 needs to be configured to transmit IPv6 Layer 3 services between CEs over the backbone network. In this example, PEs transmit service traffic over SR-MPLS TE tunnels.
