Example for Configuring EVPN VPWS over IS-IS SRv6 BE (CE Dual-Homing in Single-Active Mode)
===========================================================================================
...
On the network shown in [Figure 1](#EN-US_TASK_0227779374__fig_dc_vrp_srv6_cfg_all_002201), CE2 is dual-homed to PE2 and PE3. It is required that PE2 and PE3 operate in master/backup mode to transmit traffic from CE1 to CE2.
