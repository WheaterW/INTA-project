...
EVPN VPWS over SRv6 TE Policy uses public SRv6 TE Policies to carry EVPN VPWSs. As shown in [Figure 1](#EN-US_TASK_0179342422__fig1138145962319), PE1 and PE2 communicate through an IPv6 public network. An SRv6 TE Policy is deployed on the network to carry EVPN VPWSs.
