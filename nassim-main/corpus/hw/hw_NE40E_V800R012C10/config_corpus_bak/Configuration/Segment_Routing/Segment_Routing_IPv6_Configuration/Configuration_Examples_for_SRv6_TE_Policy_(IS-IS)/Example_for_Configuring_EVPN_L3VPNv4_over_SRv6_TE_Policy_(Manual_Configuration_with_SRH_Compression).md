...
On the network shown in [Figure 1](#EN-US_TASK_0000001135667113__fig3691666259), PE1, P1, P2, and PE2 are in the same AS. It is required that IS-IS be configured for these devices to achieve IPv6 network connectivity. In addition, a bidirectional SRv6 TE Policy must be deployed between PE1 and PE2 to carry EVPN L3VPNv4 services, and SRH compression must be performed to reduce the size of the SRv6 header.

**Figure 1** Networking diagram for configuring EVPN L3VPNv4 over SRv6 TE Policy in an SRH compression scenario![](../../../../public_sys-resources/note_3.0-en-us.png) 

In this example, interfaces 1 and 2 represent GE 0/1/0 and GE 0/2/0, respectively.


  
![](figure/en-us_image_0000001135304281.png "Click to enlarge")
...
1. Enable IPv6 forwarding and configure an IPv6 address for each interface.
   ...
   # Configure PE1. The configurations of P1, P2, and PE2 are similar to the configuration of PE1. For configuration details, see [Configuration Files](#EN-US_TASK_0000001135667113__example121226172748) in this section.
...
6. Configure SRv6 SIDs and configure the PEs to advertise VPN routes carrying SIDs.
   ...
   UpdateTime  : 2021-03-16 06:53:11.894                                        
   ...
   ProtocolType: STATIC                                       ProcessID   : --  
   UpdateTime  : 2021-03-16 06:52:28.547                                        
   ...
   LocatorName : P1                                           LocatorID   : 2   
   ProtocolType: STATIC                                       ProcessID   : --  
   UpdateTime  : 2021-03-16 05:51:18.247                                        
...
7. Configure an SRv6 TE Policy.
   ...
   Policy State            : Up                             State Change Time    : 2021-03-16 05:55:06  
   ...
   [~PE1] ping srv6-te policy policy-name policy1 end-op 2001:DB8:100:4::66  
     ...
     Preference: 100; Path Type: primary; Protocol-Origin: local; Originator: 0, 0.0.0.0; Discriminator: 100; Segment-List ID: 66; Xcin
   dex: 66; end-op: 2001:DB8:100:4::66                              
