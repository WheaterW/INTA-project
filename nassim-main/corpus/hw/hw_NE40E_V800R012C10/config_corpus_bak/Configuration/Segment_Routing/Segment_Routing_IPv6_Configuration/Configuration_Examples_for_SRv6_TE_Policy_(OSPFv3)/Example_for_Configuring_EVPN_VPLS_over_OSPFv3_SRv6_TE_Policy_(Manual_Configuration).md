Example for Configuring EVPN VPLS over OSPFv3 SRv6 TE Policy (Manual Configuration)
===================================================================================
...
![](figure/en-us_image_0000001216918369.png "Click to enlarge")
...
7. Configure a tunnel policy to import VPN traffic.
   ...
   ```
8. Configure each CE to access the corresponding PE.
