Example for Configuring Inter-AS EVPN L3VPNv4 over IS-IS SRv6 BE
================================================================

This section provides an example for configuring an inter-AS SRv6 BE path to carry EVPN L3VPNv4 services.

#### Networking Requirements

On the network shown in [Figure 1](#EN-US_TASK_0000001180628334__fig_dc_vrp_srv6_cfg_all_001101):
...
It is required that a bidirectional inter-AS SRv6 BE path be deployed between PE1 and PE2 to carry EVPN L3VPNv4 services.

**Figure 1** Inter-AS EVPN L3VPNv4 over SRv6 BE networking![](../../../../public_sys-resources/note_3.0-en-us.png) 

Interfaces 1 and 2 in this example represent GE 0/1/0 and GE 0/2/0, respectively.


  
![](figure/en-us_image_0000001225948079.png "Click to enlarge")
...
7. Establish a BGP EVPN peer relationship between the PEs.
8. Configure the PEs to exchange BGP EVPN routes carrying SIDs through this peer relationship.
...
2. Configure IS-IS.
   ...
   Total Peer(s): 1
   ```
3. Configure an EVPN L3VPN instance on each PE, bind the EVPN L3VPN instance to an access-side interface, and connect a CE to the PE.
   ...
   # Configure an IP address for each interface on the CEs, as shown in [Figure 1](#EN-US_TASK_0000001180628334__fig_dc_vrp_srv6_cfg_all_001101). For configuration details, see [Configuration Files](#EN-US_TASK_0000001180628334__section_dc_vrp_srv6_cfg_all_001105) in this section.
...
7. Establish an MP-EBGP peer relationship between the PEs, configure the PEs to exchange BGP VPNv4 routes carrying SIDs through this peer relationship, and enable SRv6 BE forwarding on the PEs.
   ...
   [*PE2-bgp] ipv4-family vpn-instance vpna
   [*PE2-bgp-vpna] segment-routing ipv6 best-effort evpn
...
8. Verify the configuration.
   ...
   [~CE1] ping -a 11.11.11.11 22.22.22.22
     PING 22.22.22.22: 56  data bytes, press CTRL_C to break         
       Reply from 22.22.22.22: bytes=56 Sequence=1 ttl=251 time=4 ms 
