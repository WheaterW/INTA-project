Example for Configuring L3VPNv4 over OSPFv3 SRv6 TE Policy (Manual Configuration)
=================================================================================
...
On the network shown in [Figure 1](#EN-US_TASK_0000001171118538__fig184238288365):
...
![](figure/en-us_image_0000001216918367.png)
...
1. Enable IPv6 forwarding and configure an IPv6 address for each interface.
   ...
   # Configure PE1. The configurations of the P and PE2 are similar to the configuration of PE1. For configuration details, see [Configuration Files](#EN-US_TASK_0000001171118538__example121226172748) in this section.
...
3. Configure a VPN instance on each PE, enable the IPv4 address family for the instance, and bind the interface that connects each PE to a CE to the VPN instance on that PE.
   ...
   # Configure an IP address for each interface on the CEs, as shown in [Figure 1](#EN-US_TASK_0000001171118538__fig184238288365). For configuration details, see [Configuration Files](#EN-US_TASK_0000001171118538__example121226172748) in this section.
...
6. Configure SRv6 SIDs and configure the PEs to advertise VPN routes carrying SIDs.
   ...
   ```
   ```
   [*P-ospfv3-1] segment-routing ipv6 locator as1 auto-sid-disable
   ```
   ```
   [*P-ospfv3-1] commit
   ```
   ...
   ```
   ```
   [~PE2-ospfv3-1] segment-routing ipv6 locator as1 auto-sid-disable
   ```
   ```
   [*PE2-ospfv3-1] commit
   ```
