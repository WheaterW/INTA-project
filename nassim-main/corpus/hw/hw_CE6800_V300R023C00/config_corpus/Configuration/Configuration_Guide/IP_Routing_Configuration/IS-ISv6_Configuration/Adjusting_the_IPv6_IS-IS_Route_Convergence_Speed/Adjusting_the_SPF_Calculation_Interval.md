...
Before adjusting the SPF calculation interval, you have completed the following task:
...
To solve this problem, configure an intelligent timer to control the SPF calculation interval. With an intelligent timer, you can set a short interval for SPF calculation, ensuring fast IS-IS route convergence. When the IS-IS network stabilizes, the interval for SPF calculation is increased automatically based on the configuration.
