Enabling LSP Fragment Extension on an IS-IS Device
==================================================
...
After LSP fragment extension is configured, an IS-IS device can generate more LSP fragments to advertise more routing information.
