Example for Configuring Route Summarization in an OSPF Area
===========================================================
...
On the network shown in [Figure 1](#EN-US_TASK_0000001585956549__fig_dc_vrp_ospf_cfg_009401), DeviceA, DeviceB, and DeviceC run OSPF to communicate with each other. DeviceA runs in area 0, and DeviceC runs in area 1. DeviceB is an ABR and runs in both areas. Among the routes received from DeviceA, DeviceB summarizes the routes to some network segments and advertises the summary route to DeviceC. This reduces the number of routing entries on DeviceB.

**Figure 1** Networking diagram of configuring route summarization in an OSPF area![](../public_sys-resources/note_3.0-en-us.png) 

In this example, interface1, interface2, and interface3 represent 100GE1/0/1, 100GE1/0/2, and 100GE1/0/3, respectively.


  
![](figure/en-us_image_0000001535780366.png)
...
2. Configure basic OSPF functions.
   ...
   [*DeviceC] commit
   ```
3. Configure OSPF route summarization on the ABR.
...
127.255.255.255/32  Direct  0    0             D   127.0.0.1       InLoopBack0
    ...
    192.168.1.0/24  Direct  0    0             D   192.168.1.1     100GE
    192.168.1.1/32  Direct  0    0             D   127.0.0.1       100GE1/0/1
  192.168.1.255/32  Direct  0    0             D   127.0.0.1       100GE1/0/1
   192.168.2.0/23  OSPF    10   3             D   192.168.1.2     100GE1/0/1
255.255.255.255/32  Direct  0    0             D   127.0.0.1       InLoopBack0
```

The command output shows the OSPF route advertised by DeviceB to the network segment 192.168.2.0/23.
