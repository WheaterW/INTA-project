Configuring BFD Session Check for an IS-IS Process
==================================================
...
3. Configure BFD session check for the current IS-IS process.
   ...
   To reduce the impact of traffic loss on services, you are advised to enable the BFD session check function for the IS-IS process.
