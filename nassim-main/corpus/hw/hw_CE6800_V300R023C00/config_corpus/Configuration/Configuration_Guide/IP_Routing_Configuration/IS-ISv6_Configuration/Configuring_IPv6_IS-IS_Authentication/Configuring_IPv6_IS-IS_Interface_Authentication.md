Configuring IPv6 IS-IS Interface Authentication
===============================================
...
4. Configure an authentication mode as required.
   ...
   * If the IS-IS interface is a Level-1-2 interface, and neither **level-1** nor **level-2** is specified, the authentication mode and password are configured for both Level-1 and Level-2 IIHs.![](public_sys-resources/note_3.0-en-us.png) 
