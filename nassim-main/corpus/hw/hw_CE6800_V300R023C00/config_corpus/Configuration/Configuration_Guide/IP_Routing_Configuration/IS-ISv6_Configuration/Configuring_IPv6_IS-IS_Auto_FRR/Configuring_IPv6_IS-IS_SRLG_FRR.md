Configuring IPv6 IS-IS SRLG FRR
===============================
...
Before configuring IPv6 IS-IS SRLG FRR, you have completed the following task:
...
5. (Optional) Set the solution of selecting a backup path to SRLG-disjoint path first.
