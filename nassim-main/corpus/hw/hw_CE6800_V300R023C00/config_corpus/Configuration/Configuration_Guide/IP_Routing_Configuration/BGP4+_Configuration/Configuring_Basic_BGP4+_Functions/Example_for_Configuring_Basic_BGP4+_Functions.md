...
On the network shown in [Figure 1](#EN-US_TASK_0000001176741879__fig_dc_vrp_bgp6_cfg_006501), DeviceA is in AS 65008, and DeviceB, DeviceC, and DeviceD are in AS 65009. It is required that BGP4+ be used to exchange routing information between the ASs.

**Figure 1** Network diagram of basic BGP4+ functions![](public_sys-resources/note_3.0-en-us.png) 

In this example, interface 1, interface 2, and interface 3 represent 100GE1/0/1, 100GE1/0/2, and 100GE1/0/3, respectively.


  
![](figure/en-us_image_0000001176662001.png)
...
1. Configure IBGP connections between DeviceB, DeviceC, and DeviceD.
2. Configure an EBGP connection between DeviceA and DeviceB.

#### Procedure

1. Assign an IPv6 address to each interface involved. For detailed configurations, see [Configuration Scripts](#EN-US_TASK_0000001176741879__postreq3136832204219).
