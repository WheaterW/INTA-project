Configuring Control Parameters for IPv6 PIM-SM DR Election
==========================================================
...
* [Configuring IPv6 PIM-SM in the ASM Model](vrp_ipv6pim_cfg_0007.html)
* [Configuring IPv6 PIM-SM in the SSM Model](vrp_ipv6pim_cfg_0013.html)
...
* Configure interface-specific control parameters for PIM-SM DR election.
  ...
  4. Set a DR priority for the interface.
     ...
     ```
     [pim ipv6 hello-option dr-priority](cmdqueryname=pim+ipv6+hello-option+dr-priority) priority
     ```
  ...
  5. Enable DR switchover delay and set a delay time. When an interface changes from a DR to a non-DR, the original entries are valid until the delay timer expires.
     ...
     ```
     [pim ipv6 timer dr-switch-delay](cmdqueryname=pim+ipv6+timer+dr-switch-delay) interval
     ```
