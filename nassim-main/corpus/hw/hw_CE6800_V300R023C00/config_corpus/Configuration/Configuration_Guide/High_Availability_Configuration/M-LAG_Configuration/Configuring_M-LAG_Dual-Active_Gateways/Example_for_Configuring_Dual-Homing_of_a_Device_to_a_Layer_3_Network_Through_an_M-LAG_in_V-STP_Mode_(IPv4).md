Example for Configuring Dual-Homing of a Device to a Layer 3 Network Through an M-LAG in V-STP Mode (IPv4)
==========================================================================================================
...
In [Figure 1](#EN-US_TASK_0000001512689670__fig1327610128711), a device is dual-homed to a Layer 3 network through an M-LAG, with the following requirements:
...
![](figure/en-us_image_0000002124090456.png)
...
2. On DeviceA and DeviceB, configure V-STP, create a DFS group, bind IP addresses of management interfaces to the DFS group, and configure peer-link interfaces and M-LAG member interfaces.
