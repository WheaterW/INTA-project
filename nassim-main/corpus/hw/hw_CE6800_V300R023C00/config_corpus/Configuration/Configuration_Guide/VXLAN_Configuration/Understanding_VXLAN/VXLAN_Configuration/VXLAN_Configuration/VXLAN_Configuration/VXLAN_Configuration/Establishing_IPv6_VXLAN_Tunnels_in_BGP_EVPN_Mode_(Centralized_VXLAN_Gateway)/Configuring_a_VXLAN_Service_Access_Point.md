...
[Table 2](#EN-US_TASK_0000001134307096__table5290164311710) and [Table 3](#EN-US_TASK_0000001134307096__table11150163212192) describe the mutual exclusiveness between two Layer 2 sub-interfaces to be bound to the same BD.
...
Dot1q VLAN tag termination indicates that dot1q traffic encapsulation is configured on the Layer 2 sub-interface, but dot1q transparent transmission is not. Dot1q transparent transmission indicates that dot1q traffic encapsulation and dot1q transparent transmission are both configured on the Layer 2 sub-interface.

QinQ VLAN tag termination indicates that QinQ traffic encapsulation is configured on the Layer 2 sub-interface, but QinQ transparent transmission is not. QinQ transparent transmission indicates that QinQ traffic encapsulation and QinQ transparent transmission are both configured on the Layer 2 sub-interface.
