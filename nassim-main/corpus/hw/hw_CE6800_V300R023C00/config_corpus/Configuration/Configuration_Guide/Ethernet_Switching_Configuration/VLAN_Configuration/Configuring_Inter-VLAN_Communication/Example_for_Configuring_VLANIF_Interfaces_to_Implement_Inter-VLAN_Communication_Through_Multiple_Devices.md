Example for Configuring VLANIF Interfaces to Implement Inter-VLAN Communication Through Multiple Devices
========================================================================================================
...
In [Figure 1](#EN-US_TASK_0000001130782628__fig111598353131), Host1 and Host2 connected to DeviceA belong to VLAN 2, and Host3 and Host4 connected to DeviceB belong to VLAN 3. The hosts connected to DeviceA belong to a different network segment from the hosts connected to DeviceB, and DeviceA and DeviceB can communicate at Layer 3. Host1 and Host2 need to communicate with Host3 and Host4.

**Figure 1** Networking diagram for configuring VLANIF interfaces to implement inter-VLAN communication through multiple devices![](public_sys-resources/note_3.0-en-us.png) 

In this example, interface 1, interface 2, and interface 3 represent 100GE 1/0/1, 100GE 1/0/2, and 100GE 1/0/3, respectively.


  
![](figure/en-us_image_0000001130782672.png "Click to enlarge")
...
On the hosts connected to DeviceA, set the default gateway address to 10.10.10.1/24 (IP address of VLANIF 2). On the hosts connected to DeviceB, set the default gateway address to 10.10.20.1/24 (IP address of VLANIF 3). After the configuration is complete, Host1, Host2, Host3, and Host4 can ping one another.
