...
| --- | --- | --- |
| *ifName* | Specifies the name of a source interface. | The value is a string of 1 to 63 case-sensitive characters, spaces not supported. |
| *ifType* | Specifies the type of a source interface. | - |
| *ifNum* | Specifies the number of a source interface. | The value is a string of 1 to 63 case-sensitive characters, spaces not supported. |
...
# Configure 100GE 1/0/1 as the source interface for the test instance named user test.
```
<HUAWEI> system-view
