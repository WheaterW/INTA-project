...
The **segment-policy** command applies a microsegmentation grouping policy globally.

The **undo segment-policy** command cancels the application of a microsegmentation grouping policy.



By default, no microsegmentation grouping policy is applied to the system.
...
# Create and apply a segment policy named p1.
```
<HUAWEI> system-view
