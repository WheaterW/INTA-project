...
**display sdn openflow statistics** [ **controller** [ **vpn-instance** *vpn-instance-name* ] { *ipv4-address* | *ipv6-address* } ]
...
| *ipv4-address* | Specifies the controller's IPv4 address. | The value is in dotted decimal notation. |
...
**Table 1** Description of the **display sdn openflow statistics** command output
| Item | Description |
| --- | --- |
