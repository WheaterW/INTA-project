fail-percent (ICMP jitter test instance)
========================================
...
The **fail-percent** command sets the failure percent threshold for an NQA test instance of the ICMP jitter test type.

The **undo fail-percent** command deletes the failure percent threshold configured for an NQA test instance of the ICMP jitter test type.
