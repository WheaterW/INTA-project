vlan-stacking (traffic behavior view)
=====================================
...
| --- | --- | --- |
| **vlan** *vlan-id* | Specifies the VLAN ID in the outer tag of a VLAN packet. | The value is an integer ranging from 1 to 4094. |
