timeout (ICMP Ping test instance)
=================================
...
The **timeout** command sets the timeout period of packets in an NQA test instance of ICMP Ping test type.
...
| --- | --- | --- |
| *time* | Specifies the timeout period of probe packets. | The value is an integer ranging from 1 to 60, in seconds. The default value is 3s. |
