...
| **statistics** | Displays statistics about BGP EVPN routes. | - |
| **mac-route** | Number of MAC advertisement routes. | - |
| **prefix-route** | Displays information about IP prefix routes. | - |
