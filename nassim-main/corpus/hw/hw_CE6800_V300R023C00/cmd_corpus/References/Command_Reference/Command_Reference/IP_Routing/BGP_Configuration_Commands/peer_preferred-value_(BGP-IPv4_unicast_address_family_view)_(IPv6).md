peer preferred-value (BGP-IPv4 unicast address family view) (IPv6)
==================================================================
...
**peer** *peerIpv6Addr* **preferred-value** *preferredvalue*

**undo peer** *peerIpv6Addr* **preferred-value**
...
[*HUAWEI-bgp-af-ipv4] peer FE80::1 preferred-value 50
