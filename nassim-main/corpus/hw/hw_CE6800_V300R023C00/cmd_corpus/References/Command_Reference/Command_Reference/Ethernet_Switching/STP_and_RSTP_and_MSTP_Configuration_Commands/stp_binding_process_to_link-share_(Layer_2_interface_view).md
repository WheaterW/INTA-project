stp binding process to link-share (Layer 2 interface view)
==========================================================
...
The **stp binding process to link-share** command configures an interface to participate in the status calculation of multiple Multiple Spanning Tree Protocol (MSTP) processes.

The **undo stp binding process to** command configures an interface to quit the status calculation of an MSTP process.
...
| --- | --- | --- |
| *process-id1* | Specifies the ID of the start MSTP process. | The value is an integer ranging from 1 to 256. |
| **to** *process-id2* | Specifies the ID of the end MSTP process. | The value is an integer ranging from 1 to 256. |
...
[*HUAWEI-100GE1/0/1] stp binding process 1 to 2 link-share
