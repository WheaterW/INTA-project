...
| **ipv6-prefix** *ipv6-prefix-name* | Indicates the filtering policy that is based on the IPv6 prefix list of the peer. | The value is a string of 1 to 169 case-sensitive characters. It cannot contain spaces. The string can contain spaces if it is enclosed with double quotation marks ("). |
