peer keep-all-routes (BGP-IPv4 unicast address family view) (IPv6)
==================================================================
...
**peer** *peerIpv6Addr* **keep-all-routes**

**undo peer** *peerIpv6Addr* **keep-all-routes**
...
[*HUAWEI-bgp-af-ipv4] peer FE80::1 keep-all-routes
