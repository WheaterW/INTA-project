...
| --- | --- | --- |
| *interval* | Specifies a probe interval for ND entries in the PROBE state. | The value is an integer ranging from 1000 to 4294967295, in milliseconds. |
...
# Set the probe interval for ND entries in the PROBE state on 100GE 1/0/1 to 4000 milliseconds.
```
<HUAWEI> system-view
[~HUAWEI] interface 100GE 1/0/1
[~HUAWEI-100GE1/0/1] undo portswitch
[*HUAWEI-100GE1/0/1] ipv6 enable
[*HUAWEI-100GE1/0/1] ipv6 nd nud interval 4000
