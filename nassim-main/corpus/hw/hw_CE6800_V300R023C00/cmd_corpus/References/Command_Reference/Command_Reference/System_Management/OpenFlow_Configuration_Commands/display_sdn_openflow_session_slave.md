display sdn openflow session slave
==================================
...
The **display sdn openflow session slave** command displays the OpenFlow connection session information.
...
After an OpenFlow connection is established, you can run this command to view the OpenFlow connection status and determine whether the connection is successfully established.
...
# View OpenFlow connection information in slave.
```
<HUAWEI> display sdn openflow session slave
...
**Table 1** Description of the **display sdn openflow session slave** command output
| Item | Description |
| --- | --- |
