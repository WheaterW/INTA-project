sendpacket passroute (ICMP Ping test instance)
==============================================
...
The **sendpacket passroute** command configures an NQA ICMP ping test instance to send packets without searching the routing table.
