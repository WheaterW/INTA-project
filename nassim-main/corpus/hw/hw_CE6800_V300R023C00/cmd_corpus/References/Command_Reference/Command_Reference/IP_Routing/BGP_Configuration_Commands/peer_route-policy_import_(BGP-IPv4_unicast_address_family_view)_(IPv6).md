peer route-policy import (BGP-IPv4 unicast address family view) (IPv6)
======================================================================
...
| *policy-name* | Specifies the name of a route-policy. | The value is a string of 1 to 200 case-sensitive characters without spaces. |
...
[*HUAWEI-bgp-af-ipv4] peer 2001:DB8:1::1 route-policy test-policy import
