...
The **peer soo** command configures Site-of-Origin (SoO) for a BGP peer group in a BGP VPN instance.

The **undo peer soo** command cancels the configuration.



By default, SoO is not configured for a BGP peer group in a BGP VPN instance.
...
# Configure SoO for a BGP peer group in a BGP VPN instance.
```
<HUAWEI> system-view
