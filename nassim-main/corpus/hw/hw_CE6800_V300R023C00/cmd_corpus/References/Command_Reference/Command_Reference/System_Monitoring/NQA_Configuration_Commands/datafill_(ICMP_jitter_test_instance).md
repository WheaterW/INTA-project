datafill (ICMP jitter test instance)
====================================
...
The **datafill** command fills padding characters into the Data field of packets to be sent in an NQA ICMP jitter test instance.

The **undo datafill** command disables a device from filling padding characters into the Data field of packets to be sent in an NQA ICMP jitter test instance.
