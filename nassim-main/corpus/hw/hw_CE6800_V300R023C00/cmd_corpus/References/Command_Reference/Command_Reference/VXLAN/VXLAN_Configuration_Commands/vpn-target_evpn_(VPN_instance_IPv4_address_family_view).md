...
A route distinguisher (RD) has been configured using the **route-distinguisher** command.The vpn-target evpn command can be used only after the **evpn-overlay enable** command is run.
