...
**peer** { *ipv4-address* | *ipv6-address* } **local-graceful-restart** **timer** **wait-for-rib** *wfrtime*

**undo peer** { *ipv4-address* | *ipv6-address* } **local-graceful-restart** **timer** **wait-for-rib**
