...
**dhcp client expected-lease** *time-value*
...
| --- | --- | --- |
| *time-value* | Specifies an expected lease for a DHCP client. | The value is an integer that ranges from 60 to 864000, in seconds. |
...
# Set the expected lease to 7200s on the interface 100GE1/0/1.
```
<HUAWEI> system-view
[~HUAWEI] interface 100GE 1/0/1
[*HUAWEI-100GE1/0/1] undo portswitch
[*HUAWEI-100GE1/0/1] dhcp client expected-lease 7200
