sendpacket passroute (TCP test instance)
========================================
...
The **sendpacket passroute** command configures an NQA TCP test instance to send packets without searching the routing table.
