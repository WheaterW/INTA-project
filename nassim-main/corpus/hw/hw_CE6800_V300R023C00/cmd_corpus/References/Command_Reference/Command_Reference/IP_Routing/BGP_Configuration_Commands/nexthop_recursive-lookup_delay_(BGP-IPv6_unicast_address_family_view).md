...
| --- | --- | --- |
| *delay-time* | Specifies the delay in responding to next hop changes. | The value is an integer ranging from 1 to 100, in seconds. By default, the value is 5s. |
...
[*HUAWEI-bgp-af-ipv6] nexthop recursive-lookup non-critical-event delay 20
