...
The **info-center console channel** command configures channels for outputting information to various destinations.

The **undo info-center console channel** command restores the default settings.



By default, the channel number is 0 and the channel name is console.
...
| **console** | Indicates the channel through which information is output to a console. | - |
...
# Configure the channel through which information is output to a console.
```
<HUAWEI> system-view
