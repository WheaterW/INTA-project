...
# In the public network instance, create an ACL named myacl; configure VLANIF 1 to permit IGMP Query messages with the source address 10.10.1.2, but to drop IGMP Query messages with the source address 10.10.1.1.
```
<HUAWEI> system-view
...
# In the public network instance, create ACL 2001; configure VLANIF 1 to permit IGMP Query messages with the source address 10.10.1.2, but to drop IGMP Query messages with the source address 10.10.1.1.
```
<HUAWEI> system-view
[~HUAWEI] multicast routing-enable
