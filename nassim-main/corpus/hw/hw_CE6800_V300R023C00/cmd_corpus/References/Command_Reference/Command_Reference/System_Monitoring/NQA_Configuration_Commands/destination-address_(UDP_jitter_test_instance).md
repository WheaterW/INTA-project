destination-address (UDP jitter test instance)
==============================================
...
The **destination-address** command configures a destination IP address for an NQA test instance of the UDP Jitter test type.

The **undo destination-address** command deletes the destination IP address of an NQA test instance of the UDP Jitter test type.
...
# Assign a destination IPv6 address to the test instance named user test.
```
<HUAWEI> system-view
