...
| --- | --- | --- |
| *threshold* | Specifies an absolute threshold for slow peer detection. | The value is an integer that ranges from 3 to 3600. The default value is 60. |
