...
**peer** *peerIpv6Addr* **connect-interface** { *interface-name* | *ipv6-source-addr* | *interface-type* *interface-number* | *interface-name* *ipv6-source-addr* | *interface-type* *interface-number* *ipv6-source-addr* }

**undo peer** { *ipv4-address* | *peerIpv6Addr* } **connect-interface**
