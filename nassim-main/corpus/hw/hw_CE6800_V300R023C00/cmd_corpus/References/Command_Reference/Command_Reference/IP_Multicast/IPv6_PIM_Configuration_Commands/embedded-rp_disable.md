...
The **embedded-rp disable** command disables the embedded-Rendezvous Point (RP) function.

The **undo embedded-rp disable** command enbles the embedded-RP function and restores the default setting.
...
If the undo embedded-rp disable command is run more than once, the latest configuration overrides the previous one.


Example
-------

# disables the embedded-Rendezvous Point (RP) function
```
<HUAWEI> system-view
[~HUAWEI] multicast ipv6 routing-enable
[*HUAWEI] pim ipv6
[*HUAWEI-pim6] embedded-rp disable
