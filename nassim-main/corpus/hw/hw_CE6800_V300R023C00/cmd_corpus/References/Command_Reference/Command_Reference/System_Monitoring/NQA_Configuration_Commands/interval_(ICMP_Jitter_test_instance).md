interval (ICMP Jitter test instance)
====================================
...
**interval milliseconds** *interval-mill*
...
| --- | --- | --- |
| **milliseconds** *interval-mill* | Specifies the interval at which test packets are sent, in milliseconds. | The value is an integer ranging from 10 to 60000, in milliseconds. |
