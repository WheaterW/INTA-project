...
If DLDP is enabled or disabled in the interface group view, DLDP functions are enabled or disabled on all member ports that join the interface group.


Example
-------

# Enable DLDP on 100GE 1/0/1.
```
<HUAWEI> system-view
