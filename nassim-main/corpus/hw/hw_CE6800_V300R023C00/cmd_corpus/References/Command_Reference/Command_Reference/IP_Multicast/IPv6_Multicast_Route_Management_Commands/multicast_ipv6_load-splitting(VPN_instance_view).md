multicast ipv6 load-splitting(VPN instance view)
================================================
...
| **source-group** | Indicates source and group addresses-based load splitting. This policy is applicable to the scenario where multiple multicast sources and multicast groups exist. | - |
...
# In the vpn instance, configure stable-preferred IPv6 multicast load splitting.
```
<HUAWEI> system-view
...
[*HUAWEI-vpn-instance-abcde] multicast ipv6 load-splitting stable-preferred
