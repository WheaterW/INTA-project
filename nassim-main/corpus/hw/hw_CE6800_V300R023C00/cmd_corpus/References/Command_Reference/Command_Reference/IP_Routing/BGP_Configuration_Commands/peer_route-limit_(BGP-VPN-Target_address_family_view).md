peer route-limit (BGP-VPN-Target address family view)
=====================================================
...
**peer** { *ipv4-address* | *ipv6-address* } **route-limit** *limit* [ *percentage* ] [ **alert-only** | **idle-forever** | **idle-timeout** *times* ]

**undo peer** { *ipv4-address* | *ipv6-address* } **route-limit**
...
| *limit* | Specifies the maximum number of routes that can be received from a peer. | The value is an integer ranging from 1 to 4294967295. |
...
[*HUAWEI-bgp-af-vpn-target] peer 10.2.2.2 route-limit 10000
