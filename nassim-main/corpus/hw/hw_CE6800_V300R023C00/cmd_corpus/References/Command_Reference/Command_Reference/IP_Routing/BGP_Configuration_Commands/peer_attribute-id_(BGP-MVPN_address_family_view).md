peer attribute-id (BGP-MVPN address family view)
================================================
...
**peer** *ipv4-address* **path-attribute-treat** **attribute-id** { *id* [ **to** *id2* ] } &<1-255> { **discard** | **withdraw** | **treat-as-unknown** }

**peer** *ipv4-address* **treat-with-error** **attribute-id** *id* **accept-zero-value**

**undo peer** *ipv4-address* **path-attribute-treat** **attribute-id** { *id* [ **to** *id2* ] } &<1-255> [ **discard** | **withdraw** | **treat-as-unknown** ]

**undo peer** *ipv4-address* **treat-with-error** **attribute-id** *id* [ **accept-zero-value** ]
...
[*HUAWEI-bgp-af-mvpn] peer 10.1.1.1 path-attribute-treat attribute-id 19 to 21 discard
