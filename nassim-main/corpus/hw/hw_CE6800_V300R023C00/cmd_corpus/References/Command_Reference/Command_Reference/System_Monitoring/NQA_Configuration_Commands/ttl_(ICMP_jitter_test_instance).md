...
The **ttl** command sets the time to live (TTL) value for the NQA ICMP jitter test packets.
...
| --- | --- | --- |
| *ttlValue* | Specifies the TTL value of test packets. | The value is an integer ranging from 1 to 255. The default value is 30. |
