peer listen-as-segment(BGP multi-instance VPN instance IPv4 address family view)
================================================================================
...
[*HUAWEI-bgp-instance-a-vpna] group ex listen external
[*HUAWEI-bgp-instance-a-vpna] peer ex listen-as-segment begin-as 200 end-as 300
