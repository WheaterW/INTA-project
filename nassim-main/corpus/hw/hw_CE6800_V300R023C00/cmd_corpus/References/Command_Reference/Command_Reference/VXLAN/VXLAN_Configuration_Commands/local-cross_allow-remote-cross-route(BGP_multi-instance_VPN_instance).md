local-cross allow-remote-cross-route(BGP multi-instance VPN instance)
=====================================================================
...
By default, remote EVPN routes received from the remote end can only be remotely leaked into a VPN instance. The routes of a VPN instance cannot be locally leaked into other VPN instances. To solve the problem of mutual access between different VPN instances, run the **local-cross allow-remote-cross-route** command to enable local leaking of remote EVPN routes. Then, the remote routes received by EVPN can be sent to the VPN instance and then locally leaked into other VPN instances.
...
[*HUAWEI-bgp-instance-test-vpn1] local-cross allow-remote-cross-route
