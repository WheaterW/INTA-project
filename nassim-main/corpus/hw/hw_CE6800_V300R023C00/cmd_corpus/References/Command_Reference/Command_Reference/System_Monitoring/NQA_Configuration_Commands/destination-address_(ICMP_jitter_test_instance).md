destination-address (ICMP jitter test instance)
===============================================
...
The **destination-address** command configures a destination IP address for an NQA test instance of ICMP Jitter test type.
