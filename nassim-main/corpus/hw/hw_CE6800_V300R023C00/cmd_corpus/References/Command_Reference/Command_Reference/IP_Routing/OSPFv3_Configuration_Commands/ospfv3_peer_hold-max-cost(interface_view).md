...
| **timer** *hold-max-cost-value* | Specifies a period during which OSPFv3 keeps the maximum cost in local LSAs. | The value is an integer ranging from 100 to 1000000, in milliseconds. |
...
# Set the period during which OSPFv3 keeps the maximum cost in local LSAs on an interface to 1000 ms.
```
<HUAWEI> system-view
[~HUAWEI] ospfv3 100
...
[*HUAWEI-100GE1/0/1] ospfv3 100 area 0 instance 100
[*HUAWEI-100GE1/0/1] ospfv3 peer hold-max-cost timer 1000 instance 100
