...
A single OSPF process or an IPv4 device running OSPF multi-process supports a maximum of 2000 **cost-binding** command configurations.
...
<HUAWEI> system-view
[~HUAWEI] ospf 1
[*HUAWEI-ospf-1] cost-binding interface Eth-Trunk 2 route-source-routerid 1.1.1.1
