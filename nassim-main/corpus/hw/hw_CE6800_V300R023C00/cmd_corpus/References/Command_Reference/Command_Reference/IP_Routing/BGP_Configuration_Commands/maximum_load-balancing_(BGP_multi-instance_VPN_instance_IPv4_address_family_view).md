...
| **ecmp-nexthop-changed** | Configures a BGP device to change the next hop addresses of routes for load balancing to its address only when the device advertises these routes. | - |
