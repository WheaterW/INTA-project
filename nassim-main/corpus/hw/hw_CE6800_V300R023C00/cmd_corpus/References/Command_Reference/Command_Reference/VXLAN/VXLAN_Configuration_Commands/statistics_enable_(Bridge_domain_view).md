statistics enable (Bridge domain view)
======================================
...
After running the **statistics enable** command, run the **display bridge-domain statistics** command to view traffic statistics in the BD. The command output helps you diagnose faults.
