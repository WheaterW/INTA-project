peer attribute-id (BGP-VPN-target address family view)
======================================================
...
**peer** { *peerIpv4Addr* | *peerIpv6Addr* } **treat-with-error** **attribute-id** *id* **accept-zero-value**

**undo peer** { *peerIpv4Addr* | *peerIpv6Addr* } **path-attribute-treat** **attribute-id** { *id* [ **to** *id2* ] } &<1-255> [ **discard** | **withdraw** | **treat-as-unknown** ]

**undo peer** { *peerIpv4Addr* | *peerIpv6Addr* } **treat-with-error** **attribute-id** *id* [ **accept-zero-value** ]
...
[*HUAWEI-bgp-af-vpn-target] peer 10.1.1.1 path-attribute-treat attribute-id 19 to 21 discard
