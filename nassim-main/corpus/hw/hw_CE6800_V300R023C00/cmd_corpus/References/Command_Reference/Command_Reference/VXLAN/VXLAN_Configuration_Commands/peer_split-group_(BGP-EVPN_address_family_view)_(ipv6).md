peer split-group (BGP-EVPN address family view) (ipv6)
======================================================
...
**peer** *peerIpv6Addr* **split-group** *split-group-name*

**undo peer** *peerIpv6Addr* **split-group** *split-group-name*
...
| --- | --- | --- |
| *peerIpv6Addr* | Specifies the IPv6 address of a BGP EVPN peer. | The value is a 32-digit hexadecimal number, in the format of X:X:X:X:X:X:X:X. |
| *split-group-name* | Specifies the name of the SHG to which BGP EVPN peers belong. | The value is a string of 1 to 31 case-sensitive characters, spaces not supported. The string can contain spaces if it is enclosed with double quotation marks ("). |
...
[*HUAWEI] bgp 100
[*HUAWEI-bgp] peer 2001:DB8:2::2 as-number 200
[*HUAWEI-bgp] l2vpn-family evpn
[*HUAWEI-bgp-af-evpn] peer 2001:DB8:2::2 enable
[*HUAWEI-bgp-af-evpn] peer 2001:DB8:2::2 split-group aa
