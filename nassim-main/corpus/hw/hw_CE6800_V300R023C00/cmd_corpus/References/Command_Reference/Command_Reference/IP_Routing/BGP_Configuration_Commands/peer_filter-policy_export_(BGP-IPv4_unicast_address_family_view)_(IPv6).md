peer filter-policy export (BGP-IPv4 unicast address family view) (IPv6)
=======================================================================
...
| **acl-name** *aclname* | Specifies the name of a named basic ACL. | The value is a string of 1 to 64 case-sensitive characters. It cannot contain spaces and must start with a letter. |
...
[*HUAWEI-bgp-af-ipv4] peer FE80::1 filter-policy 2001 export
