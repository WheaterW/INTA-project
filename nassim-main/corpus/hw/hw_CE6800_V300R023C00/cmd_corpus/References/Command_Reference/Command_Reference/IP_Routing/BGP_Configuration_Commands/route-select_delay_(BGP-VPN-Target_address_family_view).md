route-select delay (BGP-VPN-Target address family view)
=======================================================
...
| --- | --- | --- |
| *delay-value* | Specifies a route selection delay. | The value is an integer ranging from 0 to 3600, in seconds. |
...
[*HUAWEI-bgp-af-vpn-target] route-select delay 300
