peer filter-policy export (BGP-VPN instance IPv6 address family view)(IPv4)
===========================================================================
...
| --- | --- | --- |
| *ipv4-address* | Specifies the IPv4 address of the peer. | The value is in the dotted decimal format. |
...
[*HUAWEI-bgp-6-vpna] peer 10.1.1.1 filter-policy 2001 export
