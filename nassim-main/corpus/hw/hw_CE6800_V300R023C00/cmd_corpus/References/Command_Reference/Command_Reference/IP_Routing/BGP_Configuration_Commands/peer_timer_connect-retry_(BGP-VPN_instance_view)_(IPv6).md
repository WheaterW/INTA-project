...
| --- | --- | --- |
| *ipv6-address* | Specifies an IPv6 address of a peer. | The prefix is a 32-digit hexadecimal number, in the format of X:X:X:X:X:X:X:X. |
...
[*HUAWEI-bgp-instance-vpn1] peer 2001:DB8:1::1 timer connect-retry 60
