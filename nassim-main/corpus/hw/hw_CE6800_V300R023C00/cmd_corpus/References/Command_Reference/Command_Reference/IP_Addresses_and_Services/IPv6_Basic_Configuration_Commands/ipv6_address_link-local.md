...
The **ipv6 address link-local** command configures a link-local address for an interface.

The **undo ipv6 address link-local** command deletes the link-local address configured for an interface.
...
**ipv6 address** *ipv6-address* **link-local** [ **tag** *tag-value* ]

**undo ipv6 address** *ipv6-address* **link-local** [ **tag** *tag-value* ]
...
| --- | --- | --- |
| *ipv6-address* | Specifies the IPv6 address to be configured for the interface. | The address is a 32-digit hexadecimal number, in the format of X:X:X:X:X:X:X:X. When the link-local address is configured, the IPv6 address prefix should match FE80::/10. |
...
# Configure the link-local address fe80::1 for 100GE 1/0/1 manually.
```
<HUAWEI> system-view
[~HUAWEI] interface 100GE 1/0/1
[~HUAWEI-100GE1/0/1] undo portswitch
[*HUAWEI-100GE1/0/1] ipv6 enable
[*HUAWEI-100GE1/0/1] ipv6 address fe80::1 link-local
