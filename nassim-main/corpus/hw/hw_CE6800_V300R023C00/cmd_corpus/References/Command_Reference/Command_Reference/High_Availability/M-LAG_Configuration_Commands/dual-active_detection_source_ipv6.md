dual-active detection source ipv6
=================================
...
The **dual-active detection source ipv6** command specifies the IPv6 address bound to a DFS group.

The **undo dual-active detection source ipv6** command cancels the configuration.



By default, no IPv6 address is bound to a DFS group.
...
**dual-active detection source ipv6** *ipv6-address1* [ **peer** *ipv6-address2* [ **udp-port** *portnum* ] ] [ **timeout** *seconds* ]

**undo dual-active detection source ipv6** *ipv6-address1* [ [ **peer** *ipv6-address2* [ **udp-port** *portnum* ] ] [ **timeout** *seconds* ] ]
...
| --- | --- | --- |
| **peer** *ipv6-address2* | Specifies the peer device's IPv6 address bound to a DFS group. | The value is a 32-digit hexadecimal number, in the format of X:X:X:X:X:X:X:X. |
...
| **ipv6** *ipv6-address1* | Specifies the IPv6 address bound to a DFS group. | The value is a 32-bit hexadecimal string in format X:X:X:X:X:X:X:X. |
...
* The IPv6 addresses of the local and peer devices bound to a DFS group must be different and cannot be set to link-local addresses, multicast addresses, unspecified addresses, or loopback addresses.
* When binding an IP address to a DFS group, you are advised to configure the peer *ipv6-address*parameter. Otherwise, the enhanced DAD for double-fault failures function does not take effect.

Example
-------

# Bind an IPv6 address to a DFS group.
```
<HUAWEI> system-view
[~HUAWEI] dfs-group 1
[*HUAWEI-dfs-group-1] dual-active detection source ipv6 2001:db8:1::1 peer 2001:db8:1::2 udp-port 2048 timeout 30
