slow-peer absolute-detection (BGP-VPN-target address family view)
=================================================================
...
**slow-peer absolute-detection threshold** *absolute-threshold-value*

**slow-peer absolute-detection disable**

**undo slow-peer absolute-detection threshold** *absolute-threshold-value*
...
| --- | --- | --- |
| **threshold** *absolute-threshold-value* | Specifies an absolute threshold for slow peer detection. | The value is an integer that ranges from 3 to 3600, in seconds. The default value is 60. |
...
[*HUAWEI-bgp-af-vpn-target] slow-peer absolute-detection threshold 100
