multicast ipv6 invalid-packet pim
=================================
...
The **multicast ipv6 invalid-packet pim** command sets the maximum number of invalid IPv6 multicast protocol packets that can be stored on a device.

The **undo multicast ipv6 invalid-packet pim** command deletes the set maximum number of invalid IPv6 multicast protocol packets that can be stored on a device.
...
**multicast ipv6 invalid-packet pim max-count** *max-number*

**undo multicast ipv6 invalid-packet pim**
...
[*HUAWEI] multicast ipv6 invalid-packet pim max-count 20
