ignore-receive-lsa advertise-router (OSPFv3 view)
=================================================
...
| **area** *area-id* | Specifies the area ID in decimal format. | The value is an integer ranging from 0 to 4294967295. |
...
<HUAWEI> system-view
[~HUAWEI] ospfv3 100
[*HUAWEI-ospfv3-100] ignore-receive-lsa advertise-router 2.2.2.2
