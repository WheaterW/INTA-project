peer route-limit (BGP-IPv4 unicast address family view) (IPv6)
==============================================================
...
**peer** *peerIpv6Addr* **route-limit** [ **accept-prefix** ] *limit* [ *percentage* ] [ **alert-only** | **idle-forever** | **idle-timeout** *times* ]
...
[*HUAWEI-bgp-af-ipv4] peer 2001:DB8:1::1 route-limit 10000
