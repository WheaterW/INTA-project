vpn-instance (UDP jitter test instance)
=======================================
...
The **vpn-instance** command specifies a VPN instance for an NQA UDP jitter test instance.

The **undo vpn-instance** command deletes the VPN instance for an NQA UDP jitter test instance.
