...
The **ripng split-horizon** command enables split horizon for RIPng Update packets.
...
Split horizon is used to prevent routing loops. It prevents routes learned from an interface from being advertised through this interface.By default, split horizon is enabled for RIPng. Disabling split horizon is not recommended.
...
# Disable split horizon for RIPng Update packets (split horizon is enabled for RIPng Update packets by default).
```
<HUAWEI> system-view
[~HUAWEI] interface 100GE 1/0/1
[~HUAWEI-100GE1/0/1] undo portswitch
[*HUAWEI-100GE1/0/1] ipv6 enable
[*HUAWEI-100GE1/0/1] undo ripng split-horizon
