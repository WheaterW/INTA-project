ipv6 nd collect host enable (Bridge domain view)
================================================
...
# Enable the flooding of proxy ND entries generated on a device through EVPN routes in a Layer 2 interworking scenario.
```
<HUAWEI> system-view
[~HUAWEI] bridge-domain 10
[*HUAWEI-bd10] ipv6 nd multicast-suppress proxy-reply enable
[*HUAWEI-bd10] ipv6 nd collect host enable
