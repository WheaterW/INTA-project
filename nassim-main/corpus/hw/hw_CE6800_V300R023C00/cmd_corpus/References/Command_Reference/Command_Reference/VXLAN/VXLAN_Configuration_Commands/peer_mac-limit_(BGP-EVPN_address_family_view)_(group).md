...
| *number* | Specifies the maximum number of MAC advertisement routes allowed to be received from a peer. | The value is an integer that ranges from 1 to 4294967295. |
