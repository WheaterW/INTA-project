...
Peers in the same peer group can have different import and export routing policies.The **undo peer group enable** command provides the same function as the **undo peer enable** command.
...
[*HUAWEI-bgp-6-vpn1] peer 10.1.1.1 group test enable
