peer group (BGP-MVPN address family view)
=========================================
...
**peer** *ipv4-address* **group** *peerGroupName*

**undo peer** *ipv4-address* **group** *peerGroupName*
...
[*HUAWEI-bgp-af-mvpn] peer 10.1.1.1 group test
