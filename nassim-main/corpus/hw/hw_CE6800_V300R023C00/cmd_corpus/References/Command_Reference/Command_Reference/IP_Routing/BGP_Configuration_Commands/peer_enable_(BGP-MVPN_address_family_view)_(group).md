peer enable (BGP-MVPN address family view) (group)
==================================================
...
# Enable a device to exchange routing information with a specified peer in the BGP-MVPN address family view.
```
<HUAWEI> system-view
[~HUAWEI] bgp 100
