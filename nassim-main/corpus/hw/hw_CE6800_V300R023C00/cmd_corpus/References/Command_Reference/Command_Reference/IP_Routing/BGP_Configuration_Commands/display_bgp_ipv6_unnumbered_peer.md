display bgp ipv6 unnumbered peer
================================
...
The **display bgp ipv6 unnumbered peer** command displays information about BGP IPv6 unnumbered peers.
...
To check information about BGP IPv6 unnumbered peers, run the **display bgp ipv6 unnumbered peer** command.
...
# Display information about BGP IPv6 unnumbered peers.
```
<HUAWEI> display bgp ipv6 unnumbered peer
 ...
 Peers in established state : 1
  ...
  FE80::3A9C:B2FF:FE21:300         4         100      303      306     0 04:19:36 Established        0         100GE1/0/8

```

**Table 1** Description of the **display bgp ipv6 unnumbered peer** command output
| Item | Description |
| --- | --- |
...
| PrefRcv | Number of route prefixes received from the peer. |
