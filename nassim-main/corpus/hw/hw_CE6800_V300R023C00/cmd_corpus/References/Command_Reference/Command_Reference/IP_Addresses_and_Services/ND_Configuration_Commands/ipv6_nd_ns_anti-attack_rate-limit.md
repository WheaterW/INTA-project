ipv6 nd ns anti-attack rate-limit
=================================
...
By default, 2000 NS messages are sent per second.
...
**ipv6 nd ns anti-attack rate-limit** *limit-number*

**undo ipv6 nd ns anti-attack rate-limit** *limit-number*

**undo ipv6 nd ns anti-attack rate-limit**
...
| --- | --- | --- |
| *limit-number* | Specifies the rate at which NS messages are sent. | The value is an integer in the range of 1 to 5000, in packets per second. |
...
# Configure the rate at which NS messages are sent as 3000.
```
<HUAWEI> system-view
[~HUAWEI] ipv6 nd ns anti-attack rate-limit 3000
