peer graceful-shutdown(BGP view)(group)
=======================================
...
# Enable the g-shut feature for a peer group in the BGP view.
```
<HUAWEI> system-view
[~HUAWEI] bgp 100
[*HUAWEI-bgp] group aa
[*HUAWEI-bgp] peer aa graceful-shutdown local-preference 1
