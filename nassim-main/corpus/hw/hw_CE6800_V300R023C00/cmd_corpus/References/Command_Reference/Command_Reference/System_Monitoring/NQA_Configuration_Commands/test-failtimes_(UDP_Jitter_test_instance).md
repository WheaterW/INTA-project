test-failtimes (UDP Jitter test instance)
=========================================
...
The **test-failtimes** command sets the threshold for the number of consecutive failures of an NQA UDP jitter test instance. Once this threshold is reached, a trap is sent to the NMS.

The **undo test-failtimes** command restores the default threshold for the number of consecutive failures of an NQA UDP jitter test instance.
