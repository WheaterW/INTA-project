...
| *acl6-number* | Specifies the number of the basic ACL. | The value is an integer ranging from 2000 to 2999. |
| **acl6-name** *acl6-name* | Specifies the name of a basic named ACL6. | The value is a string of 1 to 64 case-sensitive characters. It cannot contain spaces and must start with a letter. |
