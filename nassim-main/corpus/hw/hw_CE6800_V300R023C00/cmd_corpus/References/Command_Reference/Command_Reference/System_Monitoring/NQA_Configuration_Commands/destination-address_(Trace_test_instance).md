destination-address (Trace test instance)
=========================================
...
The **destination-address** command configures a destination IP address for an NQA test instance of the trace test type.

The **undo destination-address** command deletes the destination IP address of an NQA test instance of the trace test type.
