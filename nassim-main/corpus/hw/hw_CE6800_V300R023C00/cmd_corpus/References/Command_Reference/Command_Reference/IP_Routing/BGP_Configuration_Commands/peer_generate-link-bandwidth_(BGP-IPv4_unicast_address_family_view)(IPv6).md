...
# Configure a device to obtain the link bandwidth of a specified directly connected EBGP peer and generate extended community attributes.
```
<HUAWEI> system
[~HUAWEI] bgp 100
[*HUAWEI-bgp] peer FE80::1 as-number 200
[*HUAWEI-bgp] ipv6-family unicast
[*HUAWEI-bgp-af-ipv6] peer FE80::1 enable
[*HUAWEI-bgp] ipv4-family unicast
[*HUAWEI-bgp-af-ipv4] peer FE80::1 enable
[*HUAWEI-bgp-af-ipv4] peer FE80::1 generate-link-bandwidth
