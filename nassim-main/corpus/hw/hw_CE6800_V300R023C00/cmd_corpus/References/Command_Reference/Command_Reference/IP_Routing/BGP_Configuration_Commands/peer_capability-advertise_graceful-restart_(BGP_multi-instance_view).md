...
**peer** { *ipv4-address* | *ipv6-address* } **capability-advertise** **graceful-restart**

**peer** { *ipv4-address* | *ipv6-address* } **capability-advertise** **graceful-restart** **disable**

**undo peer** { *ipv4-address* | *ipv6-address* } **capability-advertise** **graceful-restart**

**undo peer** { *ipv4-address* | *ipv6-address* } **capability-advertise** **graceful-restart** **disable**
