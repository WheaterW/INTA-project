probe-failtimes (DNS test instance)
===================================
...
The **probe-failtimes** command sets a threshold for the number of consecutive probe failures in an NQA DNS test instance. Once this threshold is reached, a trap is sent to the NMS.

The **undo probe-failtimes** command restores the default threshold for the number of consecutive probe failures in an NQA DNS test instance.
...
| --- | --- | --- |
| *failTimes* | Specifies the threshold for the number of consecutive probe failures in an NQA test instance. | The value is an integer that ranges from 1 to 15 . |
