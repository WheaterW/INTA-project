...
The **pim ipv6 hello-option holdtime** command sets the neighbor timeout period carried in PIM Hello packets to be sent by a PIM interface.

The **undo pim ipv6 hello-option holdtime** command restores the default value.
...
**pim ipv6 hello-option holdtime** *helloHoldTime*
...
If the pim ipv6 hello-option holdtime command is run more than once, the latest configuration overrides the previous one.


Example
-------

# Set the neighbor timeout period carried in PIM Hello messages sent by PIM interface 100GE1/0/1 to 120 seconds.
```
<HUAWEI> system-view
...
[*HUAWEI-100GE1/0/1] pim ipv6 hello-option holdtime 120
