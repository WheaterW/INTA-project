routing-table limit (VPN instance IPv6 address family view)
===========================================================
...
| --- | --- | --- |
| *number* | Specifies the maximum number of routes supported by a VPN instance. | Ranges from 1 to 4294967295. |
...
If simply-alert is configured, only an alarm is reported when the number of routes exceeds the threshold, and route addition is not affected.If the total number of IPv6 routes in a VPN instance exceeds the limit, both the L3VPN\_MIB\_TRAP\_THRESH\_EXCEED and hwL3vpnIpv6RouteExceed alarms are reported. If the total number of IPv6 routes in a VPN instance exceeds the middle threshold, both the L3VPN\_MIB\_TRAP\_MID\_THRESH\_EXCEED and hwL3vpnIpv6RouteThresholdExceed alarms are reported.After the **undo routing-table limit** command is run, a large number of routes may be learned, causing route overload or memory overload.
...
# Set the alarm threshold of the number of routes that the IPv6 address family of the VPN instance named vpn1 can import to 1000.
```
<HUAWEI> system-view
[~HUAWEI] ip vpn-instance vpn1
[~HUAWEI-vpn-instance-vpn1] ipv6-family
[~HUAWEI-vpn-instance-vpn1-af-ipv6] routing-table limit 1000 simply-alert
