...
The **tos** command sets the ToS value for test packets.
...
| --- | --- | --- |
| *tos-value* | Specifies the ToS value in test packets. | The value is an integer ranging from 0 to 255. The default value is 0. |
