...
| *number* | Specifies the number of an AS\_Path filter. The value ranges from 1 to 256. | The value is an integer that ranges from 1 to 256. |
| *name* | Specifies the name of an AS\_Path filter. | The value is a string of 1 to 51 case-sensitive characters, spaces not supported. |
