peer substitute-as (BGP-IPv4 unicast address family view) (IPv6)
================================================================
...
**peer** *peerIpv6Addr* **substitute-as**

**undo peer** *peerIpv6Addr* **substitute-as**
...
[*HUAWEI-bgp-af-ipv4] peer FE80::1 substitute-as
