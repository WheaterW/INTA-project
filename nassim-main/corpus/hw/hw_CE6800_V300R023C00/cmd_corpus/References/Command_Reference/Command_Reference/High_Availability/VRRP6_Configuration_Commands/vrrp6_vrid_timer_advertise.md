...
By default, the master device in a VRRP6 group sends VRRP6 Advertisement packets at an interval of 1 second.
...
| *advertise-interval* | Specifies an interval at which the master router in a VRRP6 backup group sends VRRP6 Advertisement packets. | The value is an integer ranging from 100 to 4095, in centiseconds. |
...
[*HUAWEI-100GE1/0/1] vrrp6 vrid 1 timer advertise 500
