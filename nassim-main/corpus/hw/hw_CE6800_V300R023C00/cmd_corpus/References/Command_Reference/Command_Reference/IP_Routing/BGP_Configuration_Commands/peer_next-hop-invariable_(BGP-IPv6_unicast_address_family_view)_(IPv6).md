...
| --- | --- | --- |
| *peerIpv6Addr* | Specifies the IPv6 address of a peer. | The address is in the format of X:X:X:X:X:X:X:X. |
...
[*HUAWEI-bgp] ipv6-family unicast
[*HUAWEI-bgp-af-ipv6] peer 2001:DB8:1::1 enable
[*HUAWEI-bgp-af-ipv6] peer 2001:DB8:1::1 next-hop-invariable include-static-route
