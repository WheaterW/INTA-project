send-trap (ICMP jitter test instance)
=====================================
...
The **send-trap** command configures conditions for sending a trap message in an NQA ICMP Jitter test.
...
**send-trap** { **all** | { **rtd** | **testfailure** | **testcomplete** | **owd-sd** | **owd-ds** | **jitter-sd** | **jitter-ds** | **testresult-change** } \* }

**undo send-trap** { **all** | { **rtd** | **testfailure** | **testcomplete** | **owd-sd** | **owd-ds** | **jitter-sd** | **jitter-ds** | **testresult-change** } \* }
...
| **jitter-sd** | Indicates that a trap message is sent after jitter-sd exceeds the threshold value. | - |
| **jitter-ds** | Indicates that a trap message is sent after jitter-ds exceeds the threshold. | - |
