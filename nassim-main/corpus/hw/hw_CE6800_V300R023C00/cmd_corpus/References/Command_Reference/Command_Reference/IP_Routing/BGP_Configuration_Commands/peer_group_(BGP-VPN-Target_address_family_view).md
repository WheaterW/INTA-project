peer group (BGP-VPN-Target address family view)
===============================================
...
If a nonexistent peer in the VPN target address family is added to a peer group in this address family, a VPN ORF peer relationship is established. A large number of VPN ORF peer relationships may compromise the performance.
...
[*HUAWEI-bgp-af-vpn-target] peer 10.2.2.2 group test
