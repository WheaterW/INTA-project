...
The **damping time** command enables VLAN damping and sets a delay time after which a VLANIF interface goes Down.
...
| --- | --- | --- |
| **time** *delay-time* | Specifies a delay time after which a VLANIF interface goes Down. | The value is an integer ranging from 0 to 20, in seconds. |
...
[*HUAWEI-Vlanif2] damping time 10
