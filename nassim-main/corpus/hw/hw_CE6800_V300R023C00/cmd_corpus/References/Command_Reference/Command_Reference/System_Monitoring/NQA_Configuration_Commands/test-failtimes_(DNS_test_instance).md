test-failtimes (DNS test instance)
==================================
...
The **test-failtimes** command configures a device to send traps to the NMS when the number of consecutive failures of an NQA DNS test instance reaches a specified value.
